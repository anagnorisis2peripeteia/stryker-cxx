...
def _build_parser() -> argparse.ArgumentParser:
    ...
    run.add_argument("--format", choices=["json", "markdown", "html", "sarif", "github-annotations", "mutation-testing-elements", "clear-text"], default="json")
    ...
    run_mutant.add_argument("--format", choices=["json", "markdown", "html", "sarif", "github-annotations", "mutation-testing-elements", "clear-text"], default="json")
